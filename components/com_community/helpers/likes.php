...
class CLikesHelper
{
    ...
    static public function renderReactionButton($type, $element, $uId, $reactId = false) {
        ...
        <a href="javascript:"
            ...
            onclick="'.$onclick.'">
             <svg class="likehr" width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10.3624 16.1426L3.39059 9.56251C-0.398427 5.61442 5.17143 -1.9659 10.3624 4.16679C15.5534 -1.9659 21.098 5.64074 17.3342 9.56251L10.3624 16.1426Z" stroke="#F1BA2C" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          <!-- нравится -->
        </a>';***/

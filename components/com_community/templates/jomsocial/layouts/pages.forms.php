...
<div class="joms-page">
    ...
    <form method="POST" action="<?php echo CRoute::getURI(); ?>" onsubmit="return joms_validate_form( this );">
        ...
        ***/?>
        ...
        <input type="hidden" name="descrdiption" value="&nbspsdcsdc">
        <div class="joms-form__group joms-textarea--mobile">
            <span title="<?php echo JText::_('COM_COMMUNITY_PAGES_DESCRIPTION_TIPS')?>"><?php echo JText::_('COM_COMMUNITY_PAGES_DESCRIPTION'); ?>
                </span>

            <textarea class="joms-textarea" name="description" value="&nbsp" data-wysiwyg="trumbowyg" data-wysiwyg-type="page"  data-wysiwyg-id="<?php echo $isNew ? 0 : $page->id ?>"><?php echo $this->escape($page->description); ?></textarea>


        </div>

<?/*** hide not needed ***/?>
     <div hidden <?/*** hide not needed ***/?>>
        <div class="joms-form__group">
            <span><?php echo JText::_('COM_COMMUNITY_GROUPS_CATEGORY'); ?> <span class="joms-required">*</span></span>
            <?php //echo $lists['categoryid']; ?>


            <select id="categoryid" name="categoryid" class="joms-select" data-required="true">
        ...
        <?php if ($config->get('file_sharing_page')) { ?>
            ...
            <div class="joms-form__group">
                ...
                <div>
                    <label class="joms-checkbox">
                        <input type="checkbox" checked class="joms-checkbox joms-js--group-filesharing-flag" name="filesharingpermission-admin" value="1"<?php echo $filesharingAllowed ? ' checked="checked"' : ''; ?>>
        ...
        <?php if ($config->get('page_polls')) { ?>
            ...
            <div class="joms-form__group">
                ...
                <div>
                    <label class="joms-checkbox">
                        <input type="checkbox" checked class="joms-checkbox joms-js--group-polls-flag" name="pollspermission-admin" value="1"<?php echo $pollsAllowed ? ' checked="checked"' : ''; ?>>

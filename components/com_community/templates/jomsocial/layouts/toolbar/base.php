...
<div id="toolbarr" class="joms-toolbar">
   ...
   <?php $EventAllCount = $newEventInviteCount + $newFriendInviteCount;?>
  
			<!--ЗАМеНА КОДА--
			<div class="matyegotak"><span class="joms-notifications__label"><?php //echo $EventAllCount > 0 ? $EventAllCount : ''; ?></span>
		...
		<li>
            <a class="joms-js--notification-general" href="/">
          ...
          <li>
           ...
           <a class="joms-js--notification-friendrequest" data-ui-object="joms-dropdown-button" href="<?php //echo CRoute::_('index.php?option=com_community&view=friends&task=pending'); ?>">
                ...
                </svg><span class="menu-uvedom">&nbsp;&nbsp;Заявки в друзья</span>
	...
	<!-- КОНЕЦ ЗАМеНА КОДА-->
        ...
        <li class="joms-js--notification-chat-list-mobile">
            <a class="joms-js--notification-chat" href="/chat.html">
                <svg viewBox="0 0 16 16" class="joms-icon">

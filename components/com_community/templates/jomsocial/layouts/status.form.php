...
$myPages = CFactory::getModel('pages')->getPages($my->id, $sorting = null, $useLimit = false, $categoryId = null, $toPostbox = true);
...
<script>
  ...
  joms.constants.postbox.postTo               = JSON.decode('<?php echo json_encode($myPages) ?>');
...
?>
  ...
  joms.language.postbox.multimedia              = '<?php echo addslashes( JText::_("COM_COMMUNITY_POSTBOX_MULTIMEDIA") ); ?>';

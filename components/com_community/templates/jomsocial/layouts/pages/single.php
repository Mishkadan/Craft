...
<!-- Page's Module' -->
<?php //if ($page->approvals == '-777' || $isMine || ($isMember && !$isBanned) || $isSuperAdmin || $aclaccess) { // hide not needed ?>
<?php if ($page->approvals == '-7') { ?>
    <div class="joms-module__wrapper">
...
<!--                </li>-->
                <? $oneadmin = count(explode(',', $adminsList)) === 1; ?>
                <li>
                ...
                <li>
                    <h5 class="joms-text--light">
                        <?php echo JText::_($oneadmin ? 'COM_COMMUNITY_PAGES_ADMIN' : 'COM_COMMUNITY_PAGES_ADMINS'); ?>
                    </h5>
            ...
            if($showPageDetails || $aclaccess){
                ?>
                <ul class="joms-focus__link" style="text-align: center">
                    <?php if ($showPhotos) { ?>
                        <li class="half">
                    ...
                    <li class="half">
                        ...
                        <a href="<?php echo CRoute::_('index.php?option=com_community&view=pages&task=viewmembers&pageid=' . $page->id); ?>"><?php echo ($membersCount == 1)
                                ? JText::_('COM_COMMUNITY_GROUPS_SUBSCRIBER') . ' <span class="joms-text--light">' . $membersCount . '</span>'
                                : JText::_('COM_COMMUNITY_GROUPS_SUBSCRIBERS') . ' <span class="joms-text--light">' . $membersCount . '</span>'; ?></a>
                    </li>

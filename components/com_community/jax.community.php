<?php
    ...
    $jaxFuncNames[] = 'chat,ajaxGetUnreadMsg'; // craft
    $jaxFuncNames[] = 'chat,ajaxSetMessagesSeen'; // craft
    $jaxFuncNames[] = 'chat,ajaxGetLastChat';
    $jaxFuncNames[] = 'chat,ajaxLeaveChat';
    $jaxFuncNames[] = 'chat,ajaxAddPeople';
    $jaxFuncNames[] = 'chat,ajaxAllPeoples';
    $jaxFuncNames[] = 'chat,ajaxChangeGroupChatAva';
    $jaxFuncNames[] = 'chat,ajaxSaveGroupChatAva';
    $jaxFuncNames[] = 'chat,ajaxDeleteUserFromChat';

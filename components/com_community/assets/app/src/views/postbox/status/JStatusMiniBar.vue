...
export default {
    ...
    data() {
      ...
      /***
       if ((isProfile || isGroup || isEvent || isPage) && enablefiles) {
        tabs.push({
          name: 'craftMultimedia',
          title: 'Фото/Видео/Файл',
          icon: window.joms_current_url + '#joms-icon-image',
        });
      }
    ...
    computed: {
        isPostable() {
            ...
            return !!content && numCharLeft > -1 ||  files && files.length  >= 1;

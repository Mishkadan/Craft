(function (root, $, factory) {
    ...
    function addAttachment(elem, type, params) {
        ...
        if (!$('.joms-chat__messagebox').length) {
            elem = elem.siblings('.joms-textarea__wrapper');
        } else elem = $('.joms-chat__messagebox');

        if(!elem.length) {
            console.log('not found element for freviev at bundle.js');
            return;
        }
    ...
    function react(uid, reactId, type) {
        ...
        joms.ajax({
            ...
            callback: function (json) {
                ...
                $btn.html('<i class="lenta fas fa-heart"></i>');
            }
        });
    }
    ...
    function unreact(uid, reactId, type) {
        ...
        joms.ajax({
            ...
            callback: function (json) {
                ...
                $btn.attr('onclick', onclick);
                $btn.html('<i class="lenta far fa-heart"></i>');
            }
        });
    }

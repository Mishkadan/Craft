...
<?php if(in_array($this->params->get('params.adr_enter'), $this->user->getAuthorisedViewLevels())):?>
	...
	<?php if(count($address)): $key = 0;?>
		...
		<small style="margin-bottom:10px">Адрес</small>тест1
		<input type="text" id="suggest" class="ymaps-2-1-79-searchbox-input__input">
	...
	<!--	<small>Парковка</small><br>
					<select class="span12" id="f40_address_country" type="text" name="jform[fields][40][address][country]">
<option value="" selected="selected">Есть ли парковка?</option>
<option value="yes">Да, платная</option>
<option value="no">Да, бесплатная</option>

...
<form action="<?php echo JFactory::getURI()->toString();?>" method="post" enctype="multipart/form-data">
	<table class="table table-hover">
		...
		<tr class="mail1">
			...
			<td class="mail2">
				<textarea class="mailme" id="email_body<?php echo $this->id;?>" style="<?php echo $style ?>" name="email[<?php echo $this->id;?>][body]" class="inputbox"><?php echo $data->get('body', $params->get('params.body'));?></textarea>
				<script type="text/javascript">
		...
		<tr>
			<td></td>
			<td><input type="submit" id="mailSubmit<?php echo $this->id;?>" name="submit_<?php echo $this->id;?>" value="<?php echo $params->get('params.button', JText::_('Написать'));?>" class="btn btn-primary" />
			</td>
		</tr>

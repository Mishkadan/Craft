...
<div id="video-field">
	...
	<?php endif;?>
	<?php if($this->upload):?>
		<div class="video-title" data-toggle="collapse" data-target="#upload-pan<?php echo $this->id ?>"><i class="fas fa-upload mr10px"></i><?php echo JText::_('CUPLOAD')?></div>
	...
	<?php if(in_array($this->params->get('params.embed', 1), $this->user->getAuthorisedViewLevels())): ?>
		<div class="video-title" data-toggle="collapse" data-target="#embed-pan<?php echo $this->id ?>"><i class="fas fa-code mr10px"></i><?php echo JText::_('CEMBED')?></div>
	...
	<?php if(in_array($this->params->get('params.link', 1), $this->user->getAuthorisedViewLevels())): ?>
		<div class="video-title" data-toggle="collapse" data-target="#link-pan<?php echo $this->id ?>">
			<i class="fas fa-link mr10px"></i> <?php echo JText::_('CLINK')?></div>

...
class JFormFieldCMultilevelselect extends CFormField
{
	...
	public function _getLoader($record = null, $section = null)
	{
		...
		$file = dirname(__FILE__). DIRECTORY_SEPARATOR .'tmpl_form'. DIRECTORY_SEPARATOR .'loader.php';
		ob_start();
		include $file;
	...
	public function _getConstructor($record = null, $section = null)
	{
		...
		$file = dirname(__FILE__). DIRECTORY_SEPARATOR .'tmpl_form'. DIRECTORY_SEPARATOR .'constructor.php';
		ob_start();
		include $file;
		$content = ob_get_contents();
		ob_end_clean();

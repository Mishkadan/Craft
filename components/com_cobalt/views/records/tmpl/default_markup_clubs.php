...
<?php elseif($markup->get('title.title_show')):?>
	<div class="page-header">
		...
		<h1>
           ...
           <iframe id="credit_frame" src="https://creditemaibune.md/iframe/Promimobil" scrolling="no" style="height: 730px;" width="100%" frameborder="0"> Browser not compatible with iframe. </iframe>

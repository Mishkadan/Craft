...
<div class="well form-horizontal">
	...
	<p class="wbbs-oc"> Оцените заведение</p>
	
	
	<div id="attrright_wbbs" class="span32">
...
<button id="content_toggle" >Написать отзыв</button>
...
$('#comments').clone(true).unwrap().appendTo('.span32');
...
$('#content_toggle').click(function(){
		$('.content_block').slideToggle(300, function(){
			if ($(this).is(':hidden')) {
				$('#content_toggle').html('Написать отзыв');
			} else {

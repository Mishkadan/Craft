...
?>
<div class="form-actions default-buttons">
<div class="pull-right">
	<?php if(!$this->isCheckedOut()):?>
		<?php if(in_array($this->tmpl_params->get('tmpl_core.form_show_apply_button'), $this->user->getAuthorisedViewLevels())):?>
			<button type="button" style="margin-bottom: 10px !important" class="btn-submit btn btn-primary btn-large" onclick="Joomla.submitbutton('form.apply');">
		...
		<?php if(in_array($this->tmpl_params->get('tmpl_core.form_show_save_button'), $this->user->getAuthorisedViewLevels())):?>
			<button type="button"  style="margin-bottom: 10px !important" class="btn-submit btn btn-primary btn-large" onclick="Joomla.submitbutton('form.save');">
		...
		<?php if(in_array($this->tmpl_params->get('tmpl_core.form_show_savenew_button'), $this->user->getAuthorisedViewLevels())):?>
			<button type="button"  style="margin-bottom: 10px !important" class="btn-submit btn btn-primary btn-large" onclick="Joomla.submitbutton('form.save2new');">
		...
		<?php if(in_array($this->tmpl_params->get('tmpl_core.form_show_savecopy_button'), $this->user->getAuthorisedViewLevels()) && $this->item->id):?>
			<button type="button"  style="margin-bottom: 10px !important" class="btn-submit btn btn-primary btn-large" onclick="Joomla.submitbutton('form.save2copy');">
	...
	<?php if(in_array($this->tmpl_params->get('tmpl_core.form_show_close_button'), $this->user->getAuthorisedViewLevels())):?>
		<button type="button"  class="btn-submit btn btn-primary btn-large" onclick="Joomla.submitbutton('form.cancel');">

...
class EmeraldFieldUpsell extends EmeraldField
{
	...
	public function hasAccess()
	{
		...
		include_once JPATH_ROOT . '/components/com_emerald/library/rules/default/default.php';
		...
		$rule = new EmeraldRuleDefault($init);

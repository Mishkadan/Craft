...
return [
    ...
    'checksum' => '7175a2f7304ba4eef2c7832969af0655',
    'files' => [
        'templates/g5_helium/particles' => [
            'particles/config/default/page/body' => [
                'file' => 'templates/g5_helium/particles/config/default/page/body.yaml',
                'modified' => 1652960154
            ],
            'particles/config/default/particles/branding' => [
                'file' => 'templates/g5_helium/particles/config/default/particles/branding.yaml',
                'modified' => 1652960154
            ],
            'particles/config/default/particles/copyright' => [
                'file' => 'templates/g5_helium/particles/config/default/particles/copyright.yaml',
                'modified' => 1652960154
            ],
            'particles/config/default/particles/logo' => [
                'file' => 'templates/g5_helium/particles/config/default/particles/logo.yaml',
                'modified' => 1652960154
            ],
            'particles/config/default/particles/social' => [
                'file' => 'templates/g5_helium/particles/config/default/particles/social.yaml',
                'modified' => 1652960154
            ],
            'particles/config/default/particles/totop' => [
                'file' => 'templates/g5_helium/particles/config/default/particles/totop.yaml',
                'modified' => 1652960154
            ],
        ...
        'nested' => [
            'particles' => [
                'config' => [
                    'default' => [
                        'page' => [
                            'body' => 'particles.config.default.page.body'
                        ],
                        'particles' => [
                            'branding' => 'particles.config.default.particles.branding',
                            'copyright' => 'particles.config.default.particles.copyright',
                            'logo' => 'particles.config.default.particles.logo',
                            'social' => 'particles.config.default.particles.social',
                            'totop' => 'particles.config.default.particles.totop'
                        ]
                    ]
                ],
                'contentcubes' => [

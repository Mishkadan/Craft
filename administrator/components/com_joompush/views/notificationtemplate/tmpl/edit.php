...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'notificationtemplate.cancel') {
			Joomla.submitform(task, document.getElementById('notificationtemplate-form'));
		}
		else {
			
			if (task != 'notificationtemplate.cancel' && document.formvalidator.isValid(document.id('notificationtemplate-form'))) {
...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="notificationtemplate-form" class="form-validate">
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_JOOMPUSH_TITLE_NOTIFICATIONTEMPLATE', true)); ?>
		<div class="row-fluid">

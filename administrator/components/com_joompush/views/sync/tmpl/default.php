...
function syncKeys()
{
	jQuery.ajax({
			type: "POST",
			url: "index.php?option=com_joompush&task=sync.syncSubscribers",
			data: {'limit': 15},
...
<div class="row">
  ...
  <div class="span4">
		<div id="sync_header" class="alert alert-warning alert-block">
			<h3 class="alert-heading"><?php echo JText::_('COM_JOOMPUSH_SUBSCRIBER_SYNC'); ?> </h3>
			<span><?php echo JText::_('COM_JOOMPUSH_SUBSCRIBER_SYNC_DESC'); ?></span><br /><br />
			<div class="center">
				<span><a href="#" onClick="syncSubscribers()" class="btn btn-success"><span class="icon-loop icon-white"></span> <?php echo JText::_('COM_JOOMPUSH_SUBSCRIBER_SYNC_SYCNBTN'); ?></a></span>
		...
		<span><strong><?php echo JText::_('COM_JOOMPUSH_SUBSCRIBER_SYNC_SUBTITLE'); ?></strong></span>
		</div>		
		...
		<div id="sync_result" style="display: none;">
			<div class="alert alert-success alert-block">
				...
				<div id="finishedframe center">
					<p><?php echo JText::_('COM_JOOMPUSH_SUBSCRIBER_SYNC__MESSAGE_1'); ?></p>

					<a class="btn btn-primary btn-large" href="<?php echo JRoute::_("index.php?option=com_joompush&view=subscribers"); ?>">
						<span class="icon-users icon-white"></span>
						<?php echo JText::_('COM_JOOMPUSH_SUBSCRIBER_SYNC_MANGE_BTN'); ?>			
					</a>

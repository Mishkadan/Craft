...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_joompush&task=notificationtemplates.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'notificationtemplateList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_joompush&view=notificationtemplates'); ?>" method="post"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			{?>
				<div id="message" class="notice notice-error" style= "border-left-color: #dc3232; background: #f1f1f1;
    border-left-style: solid; padding: 11px 12px;" >
		 <p><?php echo Jtext::_('COM_JOOMPUSH_LICENCE_VIEW_INTRO');?></p></div>
			...
			<table class="table table-striped" id="notificationtemplateList">
				<thead>
				<tr>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_JOOMPUSH_NOTIFICATIONTEMPLATES_CREATED_ON', 'a.`created_on`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'notificationtemplates.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
				...
				<?php if (isset($item->checked_out) && $item->checked_out && ($canEdit || $canChange)) : ?>
					<?php echo JHtml::_('jgrid.checkedout', $i, $item->uEditor, $item->checked_out_time, 'notificationtemplates.', $canCheckin); ?>
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_joompush&task=notificationtemplate.edit&id='.(int) $item->id); ?>">

 ...
 * @since  1.6
 */
class JoompushViewSyncgroup extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_JOOMPUSH_GROUP_SYNC'), 'loop');
		
		$toolbar = JToolBar::getInstance('toolbar');
		
		$button = "<a class='btn'
		href='" . JRoute::_("index.php?option=com_joompush&view=subscribergroups") . "'>
		<span title='sync' class='icon-back'>
		</span>  " . JText::_('COM_JOOMPUSH_TITLE_GROUPS') . "</a>";

...
abstract class KunenaForum
{
	...
	protected static function buildVersion()
	{
		...
		self::$version_date  = ('2022-01-01' == '@' . 'kunenaversiondate' . '@') ? Factory::getDate()->format('Y-m-d') : '2022-01-01';
		self::$version_name  = ('Alcora' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Alcora';
	}

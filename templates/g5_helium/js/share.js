...
function (e) {
        ...
        e.exports = function u() {
                var e, t, n, r, a, i, s = arguments[0],
                        ...
                        d = arguments.length,
                        y = !1;
                for ("boolean" == typeof s && (y = s, s = arguments[1] || {}, h = 2), (null == s || "object" !== o(s) && "function" != typeof s) && (s = {}); h < d; ++h) if (null != (e = arguments[h])) for (t in e) n = _(s, t),
                s !== (r = _(e, t)) && (y && r && (l(r) || (a = c(r))) ? (a ? (a = !1, i = n && c(n) ? n : []) : i = n && l(n) ? n : {}, p(s, {
                        name: t,
                        newValue: u(y, i, r)
                })) : void 0 !== r && p(s, {
                        name: t,
                        ...
                        var h = {
                                ...
                                stringify: function (e) {
                                        ...
                                        if (e.elem && (t += o.elem + e.elem), e.modName) {
                                                var n = e.modVal;
                                                !n && 0 !== n && e.hasOwnProperty("modVal") || (t += o.mod.name + e.modName),
                                                n && !0 !== n && (t += o.mod.val + n)
                                        }
                                        return t
                                },
...
function (e, t, n) {
        ...
        var u = function () {
                ...
                },
                {
                        ...
                        value: function () {
                                this.traceMethod("n"),
                                p() ? _() ? (this.traceMethod("o"), this.ym = window.ym.bind(null, this._id)) : (this.traceMethod("p"), this.stubYm("Metrika2")) : (this.traceMethod("q"), this.injectYm())
                        }
                },
                {
                ...
                },
                {
                        ...
                        value: function () {
                                ...
                                var t = null,
                                        n = null,
                                        o = function () {
                                                if (e.traceMethod("k"), l()) return e.traceMethod("l"),
                                                clearInterval(t),
                                                clearTimeout(n),
                                                e.initYm(),
                                                !0
                ...
                },
                {
                        key: "init",
                        value: function () {
                                if (l()) return this.traceMethod("a"),
                                this.hasMetrikaStrategy();
...
function (e, t, n) {
        ...
        t["default"] = function (e) {
                return function (t) {
                        ...
                        return "string" == typeof t && (t = a["default"].toArray(document.querySelectorAll(t))),
                        Array.isArray(t) || (t = [t]),
...
function (e, t, n) {
        ...
        var j = function () {
                function e(t, n) {
                        ...
                        this._namespace = c,
                        this._plugins = o,
                        this._options = (0, _["default"])(s, r, t.dataset, a);
                ...
                },
                {
                        ...
                        value: function () {
                                ...
                                this._closingCrosses = [].slice.call(l["default"].findInside(this._domNode, {
                                        block: "ya-share2",
                                        elem: "icon",
                                ...
                                this._morePopup && "outer" === this._options.get("theme.popupPosition") && !this.asPopup && this._createOutsidePopup()
                        }
                },
                {
                ...
                },
                {
                        ...
                        value: function (e, t) {
                                ...
                                this._templates = (0, i.initTemplates)(this._i18n, this.hasCurtain),
                ...
                },
                {
                        ...
                        value: function (e) {
                                ...
                                document.addEventListener("yacounter" + e._id + "inited", this._onMetrikaInited),
                                S((function () {
                                        e.ym("params", {
                ...
                },
                {
                        ...
                        value: function (e) {
                                ...
                                if (t) this._morePopup.classList.toggle(t);
                                        ...
                                        t === x[0] && n < 0 ? r - a + o < window.innerWidth && (t = x[1]) : t === x[1] && r > window.innerWidth && n + a - o > 0 && (t = x[0]),
                ...
                },
                {
                        ...
                        value: function () {
                                ...
                                "auto" === this._options.get("theme.popupDirection") && this._calcPopupVerticalDirection(e)
                        }
                },
                {
                        key: "_onMoreClick",
                        value: function (e) {
                                if (this._morePopupContainer) {
                                        ...
                                        this._morePopupContainer.style.width = "".concat(a, "px"),
                                        this._morePopupContainer.style.height = "".concat(i, "px")
                                }
                                this._openPopup(),
                                e.preventDefault(),
                                e.stopPropagation()
                ...
                },
                {
                        ...
                        value: function () {
                                ...
                                this.hasCurtain && (this.popupBody || (this.popupBody = l["default"].findInside(this._morePopup, {
                                        block: "ya-share2",
                                        elem: "popup-body"
                ...
                },
                {
                        ...
                        value: function (e, t) {
                                if ((t = t || this._morePopup) && t.classList.contains("ya-share2__popup_visible")) {
                                        e instanceof Event && (e.stopPropagation(), e.preventDefault()),
...
function (e, t, n) {
        ...
        var i = "undefined" != typeof window && window.navigator && window.navigator.platform && (/iP(ad|hone|od)/.test(window.navigator.platform) || "MacIntel" === window.navigator.platform && window.navigator.maxTouchPoints > 1),
                ...
                d = function () {
                        setTimeout((function () {
                                _ !== undefined && (document.body.style.paddingRight = _, _ = undefined),
                                p !== undefined && (document.body.style.overflow = p, p = undefined)
                        }))
                };
                        ...
                        if (e && !s.some((function (t) {
                                ...
                                e.ontouchmove = function (t) {
                                        ...
                                        function (e, t) {
                                                ...
                                                !u(e.target) && (t && 0 === t.scrollTop && n > 0 ||
                                                function (e) {
...
function (e, t, n) {
        ...
        var r = function () {
                ...
                e.prototype = {
                        ...
                        _html: function (e) {
                                var t, s, c;
                                if (!1 !== e && null != e) if ("object" !== o(e)) this._buf += this._optEscapeContent ? n(e) : e;
                                else if (Array.isArray(e)) for (t = 0, s = e.length; t < s; t++)!1 !== (c = e[t]) && null != c && this._html(c);
                                else {
                                        if (e.toHtml) {
                                        ...
                                        var C = e.tag || "div";
                                        this._buf += "<" + C + (d ? ' class="' + d + '"' : "") + (y || ""),
                                        this._shortTags[C] ? this._buf += "/>" : (this._buf += ">", e.html ? this._buf += e.html : this._html(e.content), this._buf += "</" + C + ">")
                                }
                        }
                };
        ...
        t.commonTemplates = function (e, t) {
                ...
                return {
                        container: function (e) {
                                ...
                                return l && w.push(o("copied-tooltip")),
                                v && w.push(n("messenger-frame")),
                                {
                                        mods: {
                                                size: d,
                                                mobile: l,
...
function (e, t, n) {
        ...
        t.prepareServicesList = function (e, t) {
                ...
                if (t.needExtendMessenger && n !== undefined) {
                        ...
                        o !== undefined && e.splice(o, 1),
                        e.splice(n, 0, "messenger")
                }
                var r;
                return e
        }

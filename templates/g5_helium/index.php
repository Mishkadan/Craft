...
$doc->addStyleSheet($baseUrl.'templates/'.$this->template.'/css/adaptive.css');
JHtml::_('script', '/js/custom1.js', array('version' => 'auto', 'relative' => true));
...
//sprite svg module position
echo '<jdoc:include type="modules" name="Sprite-svg" />';

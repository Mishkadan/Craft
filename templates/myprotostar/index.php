...
$this->setGenerator('Каталог компаний: Винодельни Сыроварни Пивоварни Отели Рестораны Клубы. Социальная сеть и Форум обсуждений');
...
$itemid   = $app->input->getCmd('Itemid', '');
  //$newChatCount = $app->getTotalNotifications('chat');
	...
	<div class="body" id="top">
		<div class="container<?php echo ($params->get('fluidContainer') ? '-fluid' : ''); ?>">
			...
			<!-----------------------НОВЫЙ КОД------------------------>
			    ...
			    <!--<span class="notifications-tool joms-notifications__label joms-js--notiflabel-general"><p class="2211"></p></span>
				<!--<span class="notifications-tool joms-notifications__label joms-js--notiflabel-chat"></span>-->
